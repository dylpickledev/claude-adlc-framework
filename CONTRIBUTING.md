# Contributing to ADLC Agent Hub
...
# 2. Clone your fork
git clone https://github.com/YOUR-USERNAME/claude-adlc-framework.git
...
Thank you for contributing to ADLC Agent Hub! 🎉

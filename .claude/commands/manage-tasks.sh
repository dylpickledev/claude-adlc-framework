...
# Task Management Command for D&A Agent Hub
...
show_usage() {
    echo "Usage: manage-tasks [command] [options]"
    echo ""
    echo "Commands:"
    ...
    echo ""
    echo "Examples:"
    echo "  /manage-tasks status                # Show task file status"
    echo "  /manage-tasks archive              # Archive current task files"
    echo "  /manage-tasks purge --dry-run      # Preview what would be purged"
    echo "  /manage-tasks compact --force      # Archive and clean without prompts"
}

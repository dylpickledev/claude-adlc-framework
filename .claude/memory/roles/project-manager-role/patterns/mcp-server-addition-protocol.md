...
**Location**: `.claude/memory/quick-reference/<server-name>-quick-reference.md`
...
**Location**: `.claude/memory/patterns/cross-tool-integration/<pattern-name>.md`
...
**Location**: `.claude/memory/patterns/agent-mcp-integration-guide.md`

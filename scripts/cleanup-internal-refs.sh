...
sed -i '' \
  ...
  .claude/memory/patterns/github-repo-context-resolution.md
...
for file in \
  .claude/memory/patterns/cross-tool-integration/aws-docs-deployment-pattern.md \
  .claude/memory/patterns/agent-mcp-integration-guide.md \
  .claude/memory/patterns/project-completion-knowledge-extraction.md; do
